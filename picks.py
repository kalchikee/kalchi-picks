...
def send_email(subject: str, picks: list):
    ...
    for i, p in enumerate(picks, 1):
        ...
        <tr>
          ...
          <td style="padding:10px;">{emoji} {title}</td>
          <td style="padding:10px;text-align:center;font-weight:bold;color:{color};">{conf}¢</td>
          <td style="padding:10px;text-align:center;color:#888;">{vol:,}</td>
        </tr>"""
